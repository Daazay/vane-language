...
#define RC_REPORT_SEMANTIC(RC, SEV, LOC, FORMAT, ...)  report_collector_append_report_from_format(RC, DIAG_KIND_SEMANTIC, SEV, LOC, FORMAT, ##__VA_ARGS__)
#define RC_REPORT_SEMANTIC_INFO(RC, LOC, FORMAT, ...)  RC_REPORT_SEMANTIC(RC, DIAG_SEVERITY_INFO, LOC, FORMAT, ##__VA_ARGS__)
#define RC_REPORT_SEMANTIC_WARN(RC, LOC, FORMAT, ...)  RC_REPORT_SEMANTIC(RC, DIAG_SEVERITY_WARN, LOC, FORMAT, ##__VA_ARGS__)
#define RC_REPORT_SEMANTIC_ERROR(RC, LOC, FORMAT, ...) RC_REPORT_SEMANTIC(RC, DIAG_SEVERITY_ERROR, LOC, FORMAT, ##__VA_ARGS__)
