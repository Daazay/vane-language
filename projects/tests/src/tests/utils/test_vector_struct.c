...
UTEST_F(TestVectorStruct, vector_index_of1) {
    TestObject values[] = {
        test_object_create(1, 11, 10),
        test_object_create(2, 22, 20),
        test_object_create(3, 33, 30),
    ...
    TestObject value = test_object_create(3, 33, 30);
    i32 idx = vector_index_of(&utest_fixture->vec, &value, &test_object_cmp);

    ASSERT_EQ(2, idx);
}

UTEST_F(TestVectorStruct, vector_index_of2) {
    TestObject values[] = {
        test_object_create(1, 11, 10),
        test_object_create(2, 22, 20),
        test_object_create(3, 33, 30),
    ...
    TestObject value = test_object_create(5, 13, 17);
    i32 idx = vector_index_of(&utest_fixture->vec, &value, &test_object_cmp);
